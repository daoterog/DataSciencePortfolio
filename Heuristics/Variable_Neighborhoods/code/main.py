...
# Parameters
nsol = 20 # Number of solutions suggested 
...
for name in files:
    ...
    sa_rel.append(np.float32(np.round(sa_cost/lb,3)))
...
df_sa.to_csv(os.path.join(results_path,'SCP_DanielOtero_SA.csv'), header = False, index = False)
